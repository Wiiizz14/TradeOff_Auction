...
<div class="row">
		<div class="col-xs-8 col-xs-offset-2 conteneur-titre">
			<h1>Détails de la vente en cours</h1>
		</div>
	</div>
...
<form class="form-horizontal" action="./GestionDesVentes" method="post">
            ...
            <!-- Boutons retour, retrait effectué et contacter acheteur -->
            <div class ="row">
                <div class="col-xs-3 col-xs-offset-1">
                    <input type="submit" value="Retrait effectué" name="choix_vente" class="bouton-style-1">
                </div>
